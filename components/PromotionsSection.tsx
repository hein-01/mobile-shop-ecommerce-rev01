...
const PromotionsSection: React.FC = () => {
  return (
    <section className="w-full px-4 py-8 bg-pink-50/50">
            ...
            <div className="relative z-10 flex flex-col h-full p-5 text-white">
              <div className="flex justify-between items-start">
                ...
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-3xl font-black text-yellow-300 leading-none">$80</span>
              ...
              <div className="mt-auto flex justify-center">
                <img
                  alt="Lenovo Laptop"
                  className="w-48 transform group-hover:scale-105 transition-transform duration-500 drop-shadow-xl"
            ...
            <div className="relative z-10 flex flex-col h-full p-5 text-gray-800">
              ...
              <div className="flex items-end justify-between mt-auto">
                <div className="flex flex-col">
                  <span className="text-[10px] text-gray-400 line-through">U.P. $74.90</span>
                  <span className="text-2xl font-black text-orange-500">$54.90</span>
                </div>
                <img
            ...
            <div className="relative z-10 flex flex-col h-full p-5 text-white">
              ...
              <div className="mt-auto flex justify-between items-end border-t border-blue-800/50 pt-3">
                <div className="flex flex-col">
                  ...
                  <span className="text-lg font-bold text-white">$1,399</span>
                </div>
