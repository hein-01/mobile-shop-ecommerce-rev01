...
const newReleaseProducts = [
  {
    brand: "XIAOMI",
    name: "[Preorder] Xiaomi Redmi Note 15 8+256GB Mist Purple...",
    warranty: "1.0 year",
    specs: ["8/256GB"],
  ...
  {
    brand: "SAMSUNG",
    name: "Samsung Galaxy Tab A11+ 6+128GB Wi-Fi...",
    warranty: "1.0 year",
    specs: ["6/128GB"],
  ...
  {
    brand: "ONEPLUS",
    name: "OnePlus 12 16+512GB Flowy Emerald 5G",
    warranty: "2.0 years",
    specs: ["16/512GB"],
    colors: ["#32CD32"],
    priceOld: "K1,099.00",
  ...
  {
    brand: "GOOGLE",
    name: "Google Pixel 8 8+128GB Hazel 5G AI Phone",
    warranty: "1.0 year",
    specs: ["8/128GB"],
  ...
  {
    brand: "SONY",
    name: "Sony Xperia 1 V 12+256GB Black 5G",
    warranty: "1.0 year",
    specs: ["12/256GB"],
    colors: ["#000000"],
    priceOld: "K1,399.00",
                      ...
                      <div className="flex flex-col flex-1 p-4 w-full">
                        ...
                        <div className="mt-auto">
                           {(product as any).extraBadge && (
                             <div className="bg-blue-50 text-blue-600 text-[10px] font-bold px-2 py-1 rounded w-fit mb-2">{(product as any).extraBadge}</div>
                           )}
